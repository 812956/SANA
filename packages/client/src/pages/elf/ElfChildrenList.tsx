    ...
    return (
        <div className="p-8 max-w-7xl mx-auto h-full flex flex-col">
             <header className="flex justify-between items-center mb-8">
                 ...
                 <Link to="/elf/create-child" className="bg-red-600 hover:bg-red-500 text-white px-4 py-2 rounded-lg font-medium transition-colors flex items-center gap-2">
                    <User size={18} />
                    Add New Child
                 </Link>
             </header>
             ...
             <div className="flex-1 overflow-y-auto">
                {loading ? (
                    ...
                    <>
                        ...
                        {/* Pagination Controls */}
                        <div className="flex justify-center items-center gap-4 py-4 border-t border-slate-800">
                            <button 
